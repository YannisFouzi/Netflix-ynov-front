...
import Subtitlepage from "../../components/UI/Subtitle/SubtitlePage";
import Modal from "../../components/UI/Modal/Modal";
import styles from "./index.module.scss";
import DescriptionPage from "../../components/UI/Description/DescriptionPage";
const Index = () => {
 ...
 // localStorage.setItem('test', parsedArray);
  ...
  return (
    <div className={styles.page__about}>
      ...
      <Subtitlepage subtitle="Où que vous soyez. Annulez à tout moment." />
      <DescriptionPage description="Prêt à regarder Netflix ? Saisissez votre adresse e-mail pour vous abonner ou réactiver votre abonnement.
" />
